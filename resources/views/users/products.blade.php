...
#sidebar ul li a.bold { font-weight: 700;} 
...
.btn-md{padding: 8px 15px!important;}
...
<!-- End Breadcrumbs -->
<!-- Product Style -->
@include('users.blocks.product-area')
<!--/ End Product Style 1  -->
...
<script>
  ...
  $(".sortme").on('click', function(e){
    e.preventDefault();
    var sort = $('select.sortby').val();
    //console.log(sort);
    setParameter('sort', sort);
    console.log(location.protocol + '//' + location.host + location.pathname + "/?sort=" +sort);
    
    const nexturl = location.protocol + '//' + location.host + location.pathname + "/?sort=" +sort;
    //setParameter('sort', sort);

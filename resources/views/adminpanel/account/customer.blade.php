...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Customer Account</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
...
<div class="content">
  <div class="container-fluid">
    @include('adminpanel.account.customer-header')
    <div class="row">
      @include('adminpanel.blocks.message')
      @include('adminpanel.account.customer-orders')
      @include('adminpanel.account.customer-transaction')
    </div>
  </div>
</div>
@endsection
